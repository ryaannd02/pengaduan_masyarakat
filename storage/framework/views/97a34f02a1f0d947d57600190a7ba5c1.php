                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $pengaduan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo e(route('admin.pengaduan.show', $p->id_pengaduan)); ?>" class="btn btn-sm btn-info">
                                        Lihat
                                    </a>
                                </td>
                            </tr>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\pengaduan_masyarakat\resources\views/admin/pengaduan/index.blade.php ENDPATH**/ ?>