...
<div class="card shadow-sm border-0">
    ...
    <div class="card-body">
        ...
        <form method="POST" action="<?php echo e(route('admin.pengaduan.update', $pengaduan->id_pengaduan)); ?>">
            <?php echo csrf_field(); ?>
            ...
            <div class="d-flex justify-content-between">
                <a href="<?php echo e(route('admin.pengaduan.index')); ?>" class="btn btn-outline-secondary">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\pengaduan_masyarakat\resources\views/admin/pengaduan/show.blade.php ENDPATH**/ ?>